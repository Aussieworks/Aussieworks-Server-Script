...
enableplaytime = true
enablebackend = false -- requires backend to be running. and also requires the backend to be from AusCode, otherwise it may not work
backendport = 8000 -- port that the backend is running on
